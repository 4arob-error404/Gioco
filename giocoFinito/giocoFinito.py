...
def controlloCollisioni(playerX, playerY, enemyX, enemyY1, enemyY2, enemyY3, enemyX2, enemyY4, enemyY5, enemyY6, cntCollisioni, macchinaFantasma, punteggio):
...
def main():
    ...
    while True:
        ...
        if macchinaFantasma == False:
            cntCollisioni, macchinaFantasma = controlloCollisioni(playerX, playerY, enemyX, enemyY1, enemyY2, enemyY3, enemyX2, enemyY4, enemyY5, enemyY6, cntCollisioni, macchinaFantasma, punteggio)
